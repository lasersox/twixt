...
* f_8 now yields the result described in rule_list.doc
* f_9 and f_10 are likely to confuse the NN's learning by introducing huge
errors: they should *not* be used.
"""
...
def f_5(game, player):
    ...
    """ ***** by Lan ***** """
    return 1 - float(float(sum(hnodes)-1)/(game.size[0]))
